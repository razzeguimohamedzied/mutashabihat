...
export const groups: MutashabihGroup[] = [
  {
    ...
    memorizationRule:
      "الآية الأولى (٥) فيها «أُولَيٰهُمَا» ، فاربطها بأنها أوّل المواضع. والآيتان الأخريان (٧ ثم ١٠٤) ترتيبهما الزمني كترتيبهما في المصحف: آية ٧ في الدنيا، وآية ١٠٤ يوم القيامة.",
    members: [
      {
        surah: 17,
        surahName: "الإسراء",
